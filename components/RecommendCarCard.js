...
export default function RecommendCarCard({
  like,
  carName,
  category,
  imageURL,
  ...
  return (
    <div className="bg-white rounded-[10px] lg:max-w-[304px] md:max-w-[327px] max-w-[425px] w-full">
      <div className="flex justify-between items-start lg:px-[24px] px-[16px] lg:pt-[24px] pt-[16px]">
        ...
        <div className="lg:w-[24px] lg:h-[24px] w-[16px] h-[16px] flex items-center justify-center">
          {likes ? (
            <svg
              width={20}
              height={18}
      ...
      <div className="flex lg:flex-col flex-row gap-x-[20px] lg:pr-[0px] pr-[16px]">
        <div
          style={{ backgroundImage: `url(${imageURL})` }}
          className="w-full lg:h-[119px] h-[74px] lg:mt-[44px] mt-[22px] lg:mb-[37px] mb-[0px] bg-no-repeat bg-contain bg-bottom"
        ></div>

        <div className="flex lg:flex-row flex-col gap-[16px] lg:justify-center justify-start lg:items-center lg:text-[14px]/[auto] text-[12px]/[auto] text-[#90A3BF] font-medium lg:px-[24px] lg:min-w-[100%] min-w-[70px] lg:mt-[0px] mt-[12px]">
      ...
      <div className="flex items-center justify-between lg:px-[24px] px-[16px] lg:pb-[24px] pb-[16px] lg:mt-[20px] mt-[32px]">
        <div className="flex flex-col">
          <div>
            <span className="lg:text-[20px]/[auto] text-[16px]/[auto] text-[#1A202C] lg:font-bold font-semibold">
              ${price}/{" "}
            </span>
            <span className="lg:text-[14px]/[auto] text-[12px]/[auto] text-[#90A3BF] lg:font-bold font-medium">
              day
            </span>
          </div>
          {discount ? (
            <span className="lg:text-[14px]/[auto] text-[12px]/[auto] text-[#90A3BF] lg:font-bold font-medium line-through">
              ${discountOldPrice}
            </span>
          ) : null}
        </div>
        <button className="lg:text-[16px]/[1.5] text-[12px]/[auto] font-semibold px-[20px] py-[10px] bg-[#3563E9] text-white rounded-[4px] cursor-pointer">
          Rent Now
        </button>
      </div>
    </div>
